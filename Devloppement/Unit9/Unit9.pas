...
StringGrid1.Cells[2,0]:='Prix_unité';
...
StringGrid1.Cells[8,0]:='Qte_Chèque';
...
begin
if MessageDlg('Etes-vous sûr de vouloir Terminer la saisie ?', mtConfirmation, [mbYes, mbNo], 0) = mrYes then
  begin
    Madate:=now;
  ...
  begin
     Append;
    datamodule10.ADOTable_vente.FieldByName('prix_unité').AsString:=stringgrid1.Cells[2,j];
...
begin
 ...
 OleApplication.Selection.Font.Color:=clgreen;
    ...
    OleApplication.Selection.Formula:='QTE_Chèques';
    OleApplication.Selection.horizontalalignment:=-4108;
    OleApplication.Selection.Interior.Color := clGray;
 ...
 OleApplication.Selection.Font.Color:=clgreen;
    ...
    OleApplication.Selection.Formula:='Montant_Chèques';
    OleApplication.Selection.horizontalalignment:=-4108;
    OleApplication.Selection.Interior.Color := clGray;
